...
alias bat="batcat --map-syntax '**/.config/i3*/*:Bourne Again Shell (bash)' --map-syntax '**/.tmux.conf:Bourne Again Shell (bash)' --map-syntax '**/bin/*:Bourne Again Shell (bash)' --map-syntax '**/scripts/*:Bourne Again Shell (bash)' --style plain --theme ansi"
alias cat=bat
